...
MatmulMultiCoreReuseMcast1DProgramFactory::shared_variables_t process_mcast_in0_program_and_create_override_variables(
    ...
    */
    ...
    if (use_global_cb) {
        ...
        // the prefetcher delivers are what compute reads, with no copy. The pipe entry is a whole
        // in1 K-block while the compute-facing page is a single tile, because the unpacker
        // addresses in1 tiles at the CB page stride.
        ...
        TT_FATAL(
            ...
            "mcast_in0 prefetcher_pipes entry_size {} B must equal the in1 K-block size {} B "
            "({} tiles of {} B)",
    ...
    log_debug(
        ...
        src1_cb_index,
        in1_single_tile_size,
        in1_cb_bytes / in1_single_tile_size,
        in1_cb_bytes);
